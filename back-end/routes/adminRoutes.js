...
//comment
router.get('/recipes/:recipeId/comments', protect, commentController.getAllCommentsForAdmin);
router.patch('/recipes/:recipeId/delete-comment/:commentId', protect, adminController.deleteCommentByAdmin);
