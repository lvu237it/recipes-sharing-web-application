...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`http://localhost:3000/authentication/forgotpass`, {
        method: "POST",
      ...
      setMessage(data.success ? "A reset link has been sent to your email." : "Failed to send reset link.");
    } catch (error) {
